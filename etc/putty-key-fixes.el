;;; putty-key-fixes.el --- fix Putty's broken keys -*- lexical-binding: t -*-

;; Putty's keyboard type needs to be set to SCO.
;; Keymap from https://www.emacswiki.org/emacs/PuTTY

;;; Code:

(defun fix-putty-keys ()
  "Putty sends bad keys. Fix them."
...
(provide 'putty-key-fixes)

;;; putty-key-fixes ends here
